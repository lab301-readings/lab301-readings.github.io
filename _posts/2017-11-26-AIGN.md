...
$x_{2D}^{proj}=Px_{3D}+\begin{matrix} c_x\\c_y\\0 \end{matrix}$
where $P=\begin{matrix} f&0&0&0\\0&f&0&0\\0&0&1&0 \end{matrix}$
...
$X_1^i=\begin{matrix} X_1^i\\Y_1^i\\Z_1^i \end{matrix}=\frac{d^i}{f}\begin{matrix} x_1^i-c_x\\y_1^i-c_y\\f \end{matrix}$
$X_2=RX_1+T$
